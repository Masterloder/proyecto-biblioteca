...
require_once("../../Controllers/Libros/Modificar_libros.php");
require_once "../../Controllers/Usuarios/Usuarios.php";
...
$DatosLibros = $Libros->getLibros();
$Cant_Libros=count($DatosLibros);
$i=0;

/*-----------Informacion de los usuarios a solicitar prestamo----------------*/
$Usuarios = new Inicio_sesion();
$DatosUsuarios= $Usuarios->GetUsuario();
$Cant_usuarios=count($DatosUsuarios);
$u=0;
...
<head>
    ...
    <link rel="stylesheet" href="../../../public/Assets/CssInicio_admin.css">
</head>
            ...
            <div class=" Contenedor">
                <form action="../../Controllers/Prestamos/Modificaciones_Prestamos.php" method="post">
                    ...
                    <div class="input-field">
                        <input type="date" value="<?php echo $fecha ; ?>" placeholder="Fecha del Prestamo"
                            name="fechaPrestamo" class="input" maxlength="30" min="2024-01-01" required />
                    </div>
                    <div class="input-field">
                        <input type="date" value="<?php echo $fecha_proxima; ?>" placeholder="Fecha de Devolucion"
                    ...
                    <div class="input-field">
                        <button type="submit" value="Registrar" name="Registrar" class="submit" >Registrar</button>
